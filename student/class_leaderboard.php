...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@600;800;900&family=Inter:wght@600;800&display=swap" rel="stylesheet">
...
<body>
    ...
    <div class="app-container">
        ...
        <div class="header-container" style="justify-content: space-between;">
            <a href="dashboard.php" class="back-link" style="font-size: 1.8rem; text-decoration: none;">🔙</a>
            <div style="font-size: 1.15rem; font-weight: 800; color: var(--text-color); text-align: center; flex-grow: 1;">
                Class Leaderboard 🏆
            </div>
        ...
        <div class="content-body" style="padding-top: 10px;">
            ...
            <div class="leaderboard-header">
                <h2 style="font-size: 1.6rem; font-weight: 900; margin-bottom: 5px; color: white;">Classmates Ranking 🥇</h2>
            ...
            <?php if (isset($error_msg)): ?>
                <div class="card" style="border-color: var(--color-primary); text-align: center;">
                    <p style="color: var(--color-primary); font-weight: 800;"><?php echo htmlspecialchars($error_msg); ?></p>
                </div>
            <?php else: ?>
                ...
                <table class="leaderboard-table">
                    <tbody>
                        ...
                        foreach ($leaderboard as $row): 
                            ...
                            $rankHtml = $rank;
                            if ($rank === 1) $rankHtml = '👑';
                            elseif ($rank === 2) $rankHtml = '🥈';
                            elseif ($rank === 3) $rankHtml = '🥉';
                        ...
                        ?>
                            <tr class="leaderboard-row <?php echo $isSelf ? 'active-student' : ''; ?>">
                                ...
                                <td class="leaderboard-cell" style="text-align: left; width: 60px;">
                                    <div class="student-avatar-small" style="margin: 0; width: 44px; height: 44px; font-size: 1.6rem; display: flex; align-items: center; justify-content: center; background-color: #f1f5f9; border-radius: 50%;">
                                        <?php 
                                ...
                                <td class="leaderboard-cell" style="text-align: left; font-size: 0.95rem; color: var(--text-color);">
                                    <?php echo htmlspecialchars($row['full_name']); ?>
                                    <?php if ($isSelf): ?>
                                        <span style="font-size:0.75rem; background-color:var(--color-primary); color:white; padding:2px 8px; border-radius:9999px; margin-left:5px; vertical-align:middle;">YOU</span>
                                    <?php endif; ?>
                                </td>
                                <td class="leaderboard-cell">
